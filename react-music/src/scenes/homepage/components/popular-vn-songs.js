...
class PopularVietNameseSongs extends Component{
render() {
    return (
        ...
        <div className="iq-card">
           <div className="iq-card-body p-0">
              ...
              <div className="feature-list text-center">
                 <h6 className="font-weight-600  mb-0">Vietnamese Song</h6>
                 <p className="mb-0">Vietnam Artist </p>
              </div>
           </div>
        </div>
     </li>
...
export default PopularVietNameseSongs;